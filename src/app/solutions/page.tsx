...
const SOLUTIONS = [
  {
    ...
    imgUrl: "/images/team-collab.webp",
    tags: [
  ...
  },
  {
    ...
    imgUrl: "/images/ai-automation.webp",
    tags: [
      { name: "Workflow Automation", href: "/services" },
  ...
  },
  {
    ...
    imgUrl: "/images/dashboard-mockup.webp",
    tags: [
  ...
  },
  {
    ...
    imgUrl: "/images/trading-desk.webp",
    tags: [
  ...
  },
  {
    ...
    imgUrl: "/images/marketing-dashboard.webp",
    tags: [
  ...
  return (
    <div className="bg-light text-ink min-h-screen">
      ...
      <main className="max-w-[1280px] mx-auto px-6">
        {/* HERO SECTION */}
        <section className="pt-[140px] pb-16 lg:pb-24 border-b border-border-ink">
            ...
            return (
              ...
              >
                ...
                <div className={`${isAlt ? "md:order-2" : "md:order-1"} flex flex-col justify-center space-y-6`}>
                  ...
                  <div className="rounded-2xl overflow-hidden aspect-[16/9] relative border border-border-ink shadow-sm bg-light">
                    <img
                      src={sol.imgUrl}
                      alt={sol.fixTitle}
                ...
                <div className={`${isAlt ? "md:order-1" : "md:order-2"} flex flex-col justify-center bg-card-bg p-8 md:p-10 rounded-3xl border border-border-ink shadow-sm`}>
                  <div className="text-xs font-bold uppercase tracking-wider text-[#2563EB] mb-3">
                    ✓ The Fix
                  </div>
                  <h3 className="font-display text-[22px] md:text-[26px] font-bold text-ink">
                    {sol.fixTitle}
                  </h3>
                  ...
                  {/* Dynamic linked tags */}
                  <div className="mt-6 border-t border-border-ink pt-5">
